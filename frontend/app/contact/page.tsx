...
const socials = [
  {
    label: "Instagram",
    href: "https://instagram.com/ameyadigital",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/ameyadigital",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    label: "YouTube",
    href: "https://youtube.com/@ameyadigital",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    label: "Facebook",
    href: "https://facebook.com/ameyadigital",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-6)" }}>
              ...
              <div ref={infoR.ref} style={{ ...infoR.style, background: "var(--color-bg-secondary)", border: "1px solid var(--color-border)", borderRadius: "var(--radius-xl)", padding: "clamp(28px, 4vw, 44px)" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-4)", marginBottom: "var(--space-6)" }}>
                  {[
                    { icon: "✉", label: "Email", val: "hello@ameyadigital.in", href: "mailto:hello@ameyadigital.in" },
                    { icon: "💬", label: "WhatsApp", val: "Chat with us now", href: "https://wa.me/919999999999" },
                    { icon: "📍", label: "Location", val: "Dehradun · Serving India & globally", href: null },
                  ].map((item) => (
                ...
                {/* WhatsApp CTA */}
                <a href="https://wa.me/919999999999" target="_blank" rel="noopener noreferrer" className="btn btn-primary" style={{ width: "100%", textDecoration: "none", display: "flex", justifyContent: "center" }}>
                  💬 Message on WhatsApp
                </a>
